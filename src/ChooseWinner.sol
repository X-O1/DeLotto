...
contract ChooseWinner is VRFConsumerBaseV2 {
    // State Variables
    Lottery lottery;
    ...
    function fulfillRandomWords(
        ...
        address payable[] memory listOfPlayers = lottery
            .getListOfLotteryPlayers();

        uint256 indexOfWinner = randomWords[0] % listOfPlayers.length;
        address payable winner = listOfPlayers[indexOfWinner];
    }
}
